    ...
    <div class="wrapper clearfix">
        <div class="zuo fl">
            <h3><a href="#"><img src="img/tx.png"/></a>
                <p class="clearfix"><span class="fl">${user.username }</span><span class="fr"><a href="logout">[退出登录]</a></span></p></h3>
            <div><h4>我的交易</h4>
                <ul>
        ...
        <div class="you fl">
            <div class="tx clearfix">
                <div class="fl clearfix"><a href="#" class="fl"><img src="img/tx.png"/></a>
                    <p class="fl"><span>${user.username }</span><a href="mygrxx.html">修改个人信息></a></p></div>
            </div>
            <div class="bott">
