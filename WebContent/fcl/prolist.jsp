...
<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="indexselect">首页</a><span>/</span><a href="proList.html" class="on">${title }</a></div>
</div><!-------------------current---------------------->
<div class="current">
...
<ul class="proList wrapper clearfix">
	...
	<c:forEach var="pro" items="${proList }">
        ...
        <dl>
            <dt><img src="../images/product/${pro.propicname } " width="80"></dt>
            <dd>${pro.proname }</dd>
            <dd>${pro.propice }</dd>
        </dl>
    </a></li>
